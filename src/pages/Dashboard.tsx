            ...
            {testStats ? (
              <div className="grid gap-3 grid-cols-2">
                <div className={cn("p-4 rounded-xl border flex flex-col items-center justify-center space-y-1", testStats.passRate <= 55 ? "bg-orange-50 text-orange-900" : "bg-green-50 text-green-900")}>
                  ...
                  <p className="text-2xl font-black">{testStats.passRate.toFixed(1)}%</p>
                </div>
                <div className={cn("p-4 rounded-xl border flex flex-col items-center justify-center space-y-1", testStats.avgDrivingFaults >= 6 ? "bg-orange-50 text-orange-900" : "bg-green-50 text-green-900")}>
                  ...
                  <p className="text-2xl font-black">{testStats.avgDrivingFaults.toFixed(1)}</p>
                </div>
                <div className={cn("p-4 rounded-xl border flex flex-col items-center justify-center space-y-1", testStats.avgSeriousFaults >= 0.55 ? "bg-orange-50 text-orange-900" : "bg-green-50 text-green-900")}>
                  ...
                  <p className="text-2xl font-black">{testStats.avgSeriousFaults.toFixed(1)}</p>
                </div>
                <div className={cn("p-4 rounded-xl border flex flex-col items-center justify-center space-y-1", testStats.examinerActionPercentage >= 10 ? "bg-orange-50 text-orange-900" : "bg-green-50 text-green-900")}>
                  ...
                  <p className="text-2xl font-black">{testStats.examinerActionPercentage.toFixed(1)}%</p>
                </div>
              </div>
            ) : (
              ...
              {serviceInfo ? (
                <>
                  <div className="text-2xl font-black">
                    {serviceInfo.minMiles?.toFixed(0)} <span className="text-xs font-bold text-muted-foreground uppercase">miles</span>
                  </div>
                  ...
                  {serviceInfo.predictedWeeks !== null && (
                    <p className="text-xs font-bold text-primary mt-2">
                      Due in approx. <span className="text-lg">{Math.ceil(serviceInfo.predictedWeeks)}</span> weeks
                    </p>
                  )}
                </>
              ) : (
          ...
          <Card key={id} className={cn("shadow-sm h-full", isPrepaidWarning ? "bg-red-50 border-red-200" : "")}>
            ...
            <CardContent>
              {prePaidInfo ? (
                <>
                  <div className="text-2xl font-black">
                    {prePaidInfo.total.toFixed(1)} <span className="text-xs font-bold text-muted-foreground uppercase">hrs</span>
                  </div>
...
<dyad-chat-summary>Implementing custom lesson rates and updating dashboard widgets.</dyad-chat-summary><dyad-write path="src/pages/Dashboard.tsx" description="Completing the Dashboard implementation with the Pending Income widget and custom rate logic.">
"use client";
