...
const AddBookingForm: React.FC<AddBookingFormProps> = ({
  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6"> {/* Increased overall spacing */}
        <div className="space-y-4"> {/* Grouping student selection */}
        ...
        <div className="space-y-4"> {/* Grouping lesson details */}
          <h3 className="text-lg font-semibold">Lesson Details</h3>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3"> {/* Made responsive */}
            <FormField
              control={form.control}
              name="lesson_type"
              render={({ field }) => (
        ...
        <div className="space-y-4"> {/* Grouping time selection */}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="flex flex-col">
                ...
                <div className="flex flex-col sm:flex-row gap-2"> {/* Made responsive */}
                  <DatePicker
                    date={field.value}
        ...
        <div className="space-y-4"> {/* Grouping notes and targets */}
          <h3 className="text-lg font-semibold">Notes & Targets</h3>
          <FormField
            control={form.control}
            name="description"
            render={({ field }) => (
        ...
        <div className="space-y-4"> {/* Grouping repeat booking options */}
          <h3 className="text-lg font-semibold">Repeat Options</h3>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3"> {/* Made responsive */}
            <FormField
              control={form.control}
              name="repeat_booking"
